...
import { SkipLevelEdgeInfo } from "@/src/pattern/graph/utils/TimelineGraphUtils";
import {
...
export function applyCollisionAvoidance(
  ...
  const patternMap = new Map<number, IPattern>();
...
function getType(source?: IPattern): string | undefined {
...
function findSkipLevelEdges(
  ...
  depthMap: Map<number, number>,
  positions: Map<number, LayoutPosition>,
  patternMap: Map<number, IPattern>,
) {
