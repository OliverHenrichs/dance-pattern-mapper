...
export async function loadAllPatternLists(): Promise<PatternList[]> {
  try {
...
export async function savePatternList(list: PatternList): Promise<void> {
  try {
...
export async function getActiveList(): Promise<PatternList | null> {
  try {
    const activeId = await getActiveListId();
...
export async function loadPatterns(listId: string): Promise<Pattern[]> {
  try {
